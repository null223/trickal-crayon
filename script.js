...
const crayonData = {
    board1: {
        ...
        buffs: {
            ...
            '全体防御力 3%': ['アメリア', 'アヤ', 'イフリート', 'エルフィン', 'カンナ', 'ギデオン', 'コミー', 'シェイディ', 'ジェイド', 'シオン・ザ・DB', 'ジュビー', 'スピッキー', 'チョッピー', 'バター', 'パトラ', 'ピコラ', 'フェスタ', 'ヘイリー', 'ベル', 'ポーシャー', 'マヨ', 'ヨミ'],
            '全体攻撃力 3%': ['アレット', 'ウイ', 'エスピー', 'カレン', 'シスト', 'ディアナ', 'ベルベット', 'メゾン', 'レヴィ', 'ルポ', 'レイジー', 'ヨミ', 'スピッキー', 'マーゴ', 'モモ'],
    ...
    board2: {
        ...
        icon: '📄',
        buffs: {
            '全体攻撃力 4%': ['アヤ', 'ギデオン', 'コミー', 'シーラ', 'シオン・ザ・DB', 'ジュビー', 'バター', 'ピコラ', 'ポーシャー', 'モモ', 'ヨミ', 'カンナ', 'スピッキー', 'ヘイリー', 'マーゴ'],
            '会心・会心ダメージ 4%': ['ウイ', 'ギデオン', 'クロエ', 'コミー', 'シオン・ザ・DB', 'シルフィール', 'ヴィヴィ', 'ピコラ', 'ポーシャー', 'リム', 'カンナ', 'ヘイリー'],
            '全体HP 4%': ['アヤ', 'ウイ', 'ギデオン', 'コミー', 'シオン・ザ・DB', 'ジュビー', 'バター', 'ピコラ', 'ポーシャー', 'ヨミ', 'リム', 'カンナ', 'スピッキー', 'ヘイリー'],
            '全体防御力 4%': ['アヤ', 'クロエ', 'シーラ', 'シルフィール', 'バター', 'ヴィヴィ', 'モモ', 'ヨミ', 'スピッキー', 'マーゴ'],
